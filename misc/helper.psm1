    ...
    if ($NetworkMode -eq "l2bridge")
    {
        $jsonSampleConfig = '{
            ...
            "delegate": {
              ...
              $configJson =  ConvertFrom-Json $jsonSampleConfig
              $configJson.name = $NetworkName
              $configJson.delegate.type = "sdnbridge.exe"
              $configJson.delegate.dns.Nameservers[0] = $KubeDnsServiceIP
              $configJson.delegate.dns.Search[0] = "svc.cluster.local"
            ...
            "delegate": {
               "type": "sdnoverlay.exe",
                ...
                "AdditionalArgs" : [
                  ...
                  {
                    "Name" : "EndpointPolicy", "Value" : { "Type" : "ProviderAddress", "Settings": { "ProviderAddress": "<MgmtIP>" }}
                  }
                ]
              }
          }'
              ...
              $configJson.name = $NetworkName
              $configJson.type = "flannel"
              $configJson.delegate.type = "sdnoverlay.exe"
              $configJson.delegate.dns.Nameservers[0] = $KubeDnsServiceIp
              $configJson.delegate.dns.Search[0] = "svc.cluster.local"
...
Export-ModuleMember Update-SDNCNIConfig
